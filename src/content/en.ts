...
// English copy (source: content-en.md).
export const en: SiteContent = {
  ui: {
    moreAboutAuthor: 'More about the author',
    furtherInterviews: 'Further interviews',
  },

  home: {
    eyebrow: 'painting on tempered glass',
    subtitle: 'Abstract worlds of shapes and colors.',
  },

  bio: {
    lead: 'My name is Václav Bednář and I am a visual artist.',
    paragraphs: [
  ...
  reference: {
    essay: {
      title: 'Fractals of Motion in the Work of Václav Bednář',
      paragraphs: [
      ...
      authorRole: 'Art Councillor, Union of Visual Artists, Olomouc',
    },
    interview: {
      source: 'Interview — OL 4YOU magazine, 2026',
      headline: 'Václav Bednář: Abstraction in painting is like jazz in music',
      intro:
      ...
      qa: [
        {
          q: 'Let’s give it a try. When did you first pick up a pencil?',
          a: [
        ...
        {
          q: 'And how did you get from drawing to color?',
          a: [
        ...
        {
          q: 'But you ended up with abstraction.',
          a: [
        ...
        {
          q: 'Your main technique is painting on tempered glass. You paint "in reverse" — from one side of the glass, but you look at it from the other. How did you come to that?',
          a: [
        ...
        {
          q: 'Which painting do people like most, and which would you want to be the most famous? Because those two don’t have to be the same.',
          a: [
        ...
        {
          q: 'Where else do you exhibit abroad?',
          a: [
        ...
        {
          q: 'How did you actually end up in Olomouc? That’s quite far from Budějovice.',
          a: [
        ...
        {
          q: 'You said it’s hard to do an interview with a painter…',
          a: [
        ...
        {
          q: 'Where, in your view, is the boundary — in art and in life?',
          a: [
      ...
      by: 'Interview by: Pavel Sedláček',
      links: [
        {
          label: 'Knihobaze.cz',
    ...
    exhibitions: [
      {
        ...
        body: [
          'Preparations are currently under way for my major exhibition titled SOUND OF COLORS, taking place during July, August, and September at NG Myslbek, Na Příkopě 1096/189, Staré Město, Prague 1.',
          'Details and information to follow in good time.',
          'You are warmly invited.',
        ],
        invite: 'You are warmly invited.',
        signature: 'Yours, Václav Bednář',
      },
    ],
  },
