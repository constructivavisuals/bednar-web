...
// Deutsche Übersetzung (Quelle: cs.ts).
export const de: SiteContent = {
  ui: {
    moreAboutAuthor: 'Mehr über den Künstler',
    furtherInterviews: 'Weitere Interviews',
  },

  home: {
    eyebrow: 'Malerei auf gehärtetem Glas',
    subtitle: 'Abstrakte Welten aus Formen und Farben.',
  },

  bio: {
    lead: 'Mein Name ist Václav Bednář und ich bin bildender Künstler.',
    paragraphs: [
  ...
  reference: {
    essay: {
      title: 'Fraktale der Bewegung im Werk von Václav Bednář',
      paragraphs: [
      ...
      authorRole: 'Kunstrat der Union der bildenden Künstler Olomouc',
    },
    interview: {
      source: 'Interview – Zeitschrift OL 4YOU, 2026',
      headline: 'Václav Bednář: Die Abstraktion in der Malerei ist wie der Jazz in der Musik',
      intro:
      ...
      qa: [
        {
          q: 'Versuchen wir es. Wann hast du zum ersten Mal einen Stift in die Hand genommen?',
          a: [
        ...
        {
          q: 'Und wie bist du von der Zeichnung zu den Farben gekommen?',
          a: [
        ...
        {
          q: 'Aber du bist bei der Abstraktion gelandet.',
          a: [
        ...
        {
          q: 'Deine Haupttechnik ist die Malerei auf gehärtetem Glas. Du malst „verkehrt herum" – von der einen Seite des Glases, betrachtest es aber von der anderen. Wie bist du darauf gekommen?',
          a: [
        ...
        {
          q: 'Welches Bild mögen die Menschen am liebsten, und welches würdest du dir am liebsten als das berühmteste wünschen? Denn das muss nicht dasselbe sein.',
          a: [
        ...
        {
          q: 'Wo stellst du im Ausland sonst noch aus?',
          a: [
        ...
        {
          q: 'Wie bist du eigentlich nach Olomouc gekommen? Das ist von Budějovice ziemlich weit.',
          a: [
        ...
        {
          q: 'Du sagtest, es sei schwer, ein Interview mit einem Maler zu führen …',
          a: [
        ...
        {
          q: 'Wo liegt deiner Meinung nach die Grenze – in der Kunst wie im Leben?',
          a: [
      ...
      by: 'Das Interview führte: Pavel Sedláček',
      links: [
        {
          label: 'Knihobaze.cz',
    ...
    exhibitions: [
      {
        ...
        dates: 'Juli – September',
        venue: 'NG Myslbek, Na Příkopě 1096/189, Staré Město, Prag 1',
        body: [
          'Derzeit laufen die Vorbereitungen für meine große Ausstellung mit dem Titel SOUND OF COLORS, die im Laufe des Juli, August und September im NG Myslbek, Na Příkopě 1096/189, Staré Město, Prag 1, stattfinden wird.',
          'Einzelheiten und Informationen reiche ich rechtzeitig nach.',
          'Sie sind herzlich eingeladen.',
        ],
        invite: 'Sie sind herzlich eingeladen.',
        signature: 'Ihr Václav Bednář',
      },
    ],
  },
