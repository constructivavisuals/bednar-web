# Václav Bednář ART — české texty (CS)

> Autentický český originál všech textů webu (zdroj: původní zadání). Struktura zrcadlí `content-en.md`. Vlož do `src/content/cs/`. Čeština je primární jazyk (kořen `/`).

---

## HOME — wordmark
**VÁCLAV BEDNÁŘ ART** *(font z letáku)*
...
*Tlačítko:* Více o autorovi →

---

## REFERENCE

### Esej — Fraktály pohybu Václava Bednáře
...
PhDr. Jiří Hastík
Výtvarný rada Unie výtvarných umělců Olomouc
...
Rozhovor vedl: Pavel Sedláček

**Další rozhovory:**
- Knihobaze.cz — https://www.knihobaze.cz/jeho-tricka-nosi-lide-po-celem-svete-jeho-obrazy-na-kalenem-skle-malovane-naruby-jsou-zname-u-nas-i-v-zahranici/
- Bratislavské noviny — https://www.bratislavskenoviny.sk/kultura/86391-jeho-diela-maju-v-zbierke-i-rolling-stones-maliar-vaclav-bednar-prichadza-prvykrat-do-bratislavy

---

## SKLO (Abstract on Glass) — sloupec textu
*(Přebírá pasáže z rozhovoru výše.)*
...
E-mail: info@badnart.cz
Instagram
Facebook — Václav Bednář
Telefon: +420 608 832 230
